...
vp =        np.array([1000, 1000, 1000, 1000, 1000])  # vp
vs =        np.array([700, 700, 700, 700, 700])  # vs
...
for i in range(len(rays)):
    ...
    print(rays[i].amplitude() * np.linalg.norm(rays[i].receiver.location - rays[i].source.location))
